...
def fetch_media_main(search_term, media_path, seasons=None, type=None, year=None):\
    ...
    search_res = [s for s in res.json() if filter_media(s, year, type)]
    ...
    if type == "movies":
        ...
        filtered_seasons = [season for season in season_list_items if seasons is None or season in seasons]
        ...
        for season_num in filtered_seasons: 
            ...
            for episode in episodes:
                ...
                dl_url = media_info['dl']
                if 'dl_hd' in media_info and media_info['dl_hd'] is not None:
                    dl_url = media_info['dl_hd']
...
if __name__ == "__main__":
    ...
    # fetch_media_main(args.name, args.media_path, seasons, args.type, args.year)

    # fetch_media_main("Lion King", "./movies", None, "movies", "1994")
    fetch_media_main("Rick and Morty", "./movies", [0], "series", None)
